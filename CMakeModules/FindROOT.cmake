...
IF( ROOT_CONFIG_EXECUTABLE )
    ...
    FIND_LIBRARY( ROOT_FOAM_LIBRARY        NAMES Foam       PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_MINUIT_LIBRARY      NAMES Minuit     PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_MINUIT2_LIBRARY     NAMES Minuit2    PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_ROOFIT_LIBRARY      NAMES RooFit     PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_ROOFITCORE_LIBRARY  NAMES RooFitCore PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_MATHMORE_LIBRARY    NAMES MathMore   PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_TREEPLAYER_LIBRARY  NAMES TreePlayer PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_MLP_LIBRARY         NAMES MLP        PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
    FIND_LIBRARY( ROOT_TMVA_LIBRARY        NAMES TMVA       PATHS ${ROOT_LIBDIR} ENV LD_LIBRARY_PATH NO_DEFAULT_PATH )
