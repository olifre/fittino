...
IF( ROOT_CONFIG_EXECUTABLE )
    ...
    SET( ROOT_LINK_FLAGS     "${ROOT_LIBS} -lFoam -lMinuit -lMinuit2 -lMathMore -lTreePlayer -lMLP -lTMVA ${ROOT_LDFLAGS}" )
    SET( ROOT_LIBRARY_DIRS   "${ROOT_LIBDIR}" )

ENDIF()

FIND_PACKAGE_HANDLE_STANDARD_ARGS( ROOT REQUIRED_VARS ROOT_CONFIG_EXECUTABLE ROOT_FOAM_LIBRARY ROOT_MATHMORE_LIBRARY ROOT_MINUIT_LIBRARY ROOT_MINUIT2_LIBRARY ROOT_MLP_LIBRARY ROOT_TMVA_LIBRARY ROOT_TREEPLAYER_LIBRARY ROOT_VERSION_STRING VERSION_VAR )
