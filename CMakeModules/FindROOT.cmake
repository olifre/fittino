...
ELSE(${ROOT_CONFIG_EXECUTABLE} MATCHES "ROOT_CONFIG_EXECUTABLE-NOTFOUND")
    ...
    # TODO: Find a better and more generic way to look for libraries!

    FIND_LIBRARY(ROOT_CORE_LIBRARY NAMES Core PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_CINT_LIBRARY NAMES Cint PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_RIO_LIBRARY NAMES RIO PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_NET_LIBRARY NAMES Net PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_HIST_LIBRARY NAMES Hist PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_GRAF_LIBRARY NAMES Graf PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_GRAF3D_LIBRARY NAMES Graf3d PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_GPAD_LIBRARY NAMES Gpad PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_TREE_LIBRARY NAMES Tree PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_RINT_LIBRARY NAMES Rint PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_POSTSCRIPT_LIBRARY NAMES Postscript PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_MATRIX_LIBRARY NAMES Matrix PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_PHYSICS_LIBRARY NAMES Physics PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_MATHCORE_LIBRARY NAMES MathCore PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_THREAD_LIBRARY NAMES Thread PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    FIND_LIBRARY(ROOT_XMLIO_LIBRARY NAMES XMLIO PATHS ${ROOT_LIBRARY_PATH} NO_DEFAULT_PATH)
    ...
    SET(ROOT_LIBRARIES ${ROOT_CORE_LIBRARY}
                       ${ROOT_CINT_LIBRARY}
		       ${ROOT_RIO_LIBRARY}
		       ${ROOT_NET_LIBRARY}
                       ${ROOT_HIST_LIBRARY}
