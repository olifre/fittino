...
#    ENDIF(FOUND_VERSION LESS MIN_VERSION)
    ...
    FIND_LIBRARY(ROOT_FOAM_LIBRARY NAMES Foam PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_MINUIT_LIBRARY NAMES Minuit PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_MINUIT2_LIBRARY NAMES Minuit2 PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_ROOFIT_LIBRARY NAMES RooFit PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_ROOFITCORE_LIBRARY NAMES RooFitCore PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_MATHMORE_LIBRARY NAMES MathMore PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_XMLPARSER_LIBRARY NAMES XMLParser PATHS ${ROOT_LIBRARY_PATH} )
    FIND_LIBRARY(ROOT_TMVA_LIBRARY NAMES TMVA PATHS ${ROOT_LIBRARY_PATH} )

    SET(ROOT_LIBRARIES ${ROOT_STANDARD_LIBRARIES} ${ROOT_XMLPARSER_LIBRARY} ${ROOT_MINUIT2_LIBRARY} ${ROOT_MINUIT_LIBRARY} ${ROOT_ROOFITCORE_LIBRARY} ${ROOT_ROOFIT_LIBRARY} ${ROOT_FOAM_LIBRARY} ${ROOT_MATHMORE_LIBRARY} ${ROOT_TMVA_LIBRARY})
