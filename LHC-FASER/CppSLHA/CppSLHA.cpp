...
namespace CppSLHA
{
  ...
  // CppSLHA0 class non-inline functions:
  ...
  // the constructor requires a file to open.
    ...
    /* the constructor sets all entries to NaN or not even assigned, in the
     * case of std::vectors of entries & also allocates the memory for the
     * particle spectrum.
     */
    is_verbose( false )
  ...
  // CppSLHA1 class non-inline functions:
  ...
  // CppSLHA2 class non-inline functions:
 ...
 "in the mSUGRA-inspired CMSSM, the cosine of the phase of the mu parameter" );
  ...
  // CppSLHA2_SPheno class non-inline functions:
