...
namespace CppSLHA
{
  ...
  public:
     ...
     * pre-existing EW_scale_spectrum, which is how one can
     * implement the NMSSM or similar.
     */
    CppSLHA0( std::string const given_SLHA_file_name,
     ...
     */
    {
      ...
      return
          particle_spectrum->get_particle_property_set( decayer_code
                               )->get_direct_decay_handler(
