...
namespace CppSLHA
{
  ...
  public:
    ...
    // : EW_scale_spectrum()
    // in here (commented) just to remind me that it constructs a
    // EW_scale_spectrum too
    /* code in .cpp file. */;
  ...
  public:
    ...
    // : FVMSSM_scale_spectrum()
    // in here (commented) just to remind me that it constructs a
    // EW_scale_FVMSSM_spectrum too.
    /* code in .cpp file. */;
    ...
    if( 0 <= column_to_draw_in )
      {
        ...
        while( column_set.size() <= column_to_draw_in )
          {
