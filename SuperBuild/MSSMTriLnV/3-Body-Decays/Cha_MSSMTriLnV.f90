...
& gTSe,gTSu,gTSv,gTVWm,gTVZ,gChaChacChaCha,gChaChaChiChi,gChaChacFdFd,gChaChacFeFe,      & 
& gChaChacFuFu,gChaChaFvFv,gChaChicFuFd,gChaChiFvFe,gChaFdcFdFe,gChaFdcFuGlu,            & 
& gChaFecFeFe,gChaFvcFuFd,gChaFvFvFe,gChacFuFuFe,epsI,deltaM,CheckRealStates,            & 
& gT,gPartial,BR)
...
& gChaChacFuFu(2,2,3,3),gChaChaFvFv(2,2,3,3),gChaChicFuFd(2,4,3,3),gChaChiFvFe(2,4,3,3), & 
& gChaFdcFdFe(2,3,3,3),gChaFdcFuGlu(2,3,3,1),gChaFecFeFe(2,3,3,3),gChaFvcFuFd(2,3,3,3),  & 
& gChaFvFvFe(2,3,3,3),gChacFuFuFe(2,3,3,3)
...
& gChaChacFuFui(2,3,3),gChaChaFvFvi(2,3,3),gChaChicFuFdi(4,3,3),gChaChiFvFei(4,3,3),     & 
& gChaFdcFdFei(3,3,3),gChaFdcFuGlui(3,3,1),gChaFecFeFei(3,3,3),gChaFvcFuFdi(3,3,3),      & 
& gChaFvFvFei(3,3,3),gChacFuFuFei(3,3,3)
...
& cplcFeFeSvL,cplcFeFeSvR,cplcFeFeVZL,cplcFeFeVZR,cplcFuChiSuL,cplcFuChiSuR,             & 
...
& cplFvFecVWmL,cplFvFecVWmR,cplFvFvVZL,cplFvFvVZR,cplGluFdcSdL,cplGluFdcSdR,deltaM)
...
gChaChaFvFvi = 0._dp 
Call ChaToChaFvFv(i_run,MCha,MVZ,MSe,cplcChaChaVZL,cplcChaChaVZR,cplcChaFvSeL,        & 
& cplcChaFvSeR,cplFvChacSeL,cplFvChacSeR,cplFvFvVZL,cplFvFvVZR,IntegralSs,               & 
& IntegralSSss,IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSst,NVVss,gTVZtemp,gTSetemp,deltaM,epsI,check,gChaChaFvFvi)
...
gChaChiFvFei = 0._dp 
Call ChaToChiFvFe(i_run,MChi,MFe,MVWm,MHpm,MSv,MSe,MCha,cplcChaChiHpmL,               & 
& cplcChaChiHpmR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,              & 
& cplcChaFvSeL,cplcChaFvSeR,cplChiFecSeL,cplChiFecSeR,cplChiFvSvL,cplChiFvSvR,           & 
& cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,cplFvFecVWmR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSss,NVSst,NVVss,gTVWmtemp,gTHpmtemp,gTSvtemp,gTSetemp,deltaM,              & 
& epsI,check,gChaChiFvFei)

gChaChiFvFe(i_run,:,:,:) = gChaChiFvFei 
gT(i_run) = gT(i_run) + Sum(gChaChiFvFei) 
 
gChaFdcFdFei = 0._dp 
Call ChaToFdcFdFe(i_run,MFd,MFe,MSu,MSv,MCha,cplcChaFdcSuL,cplcChaFdcSuR,             & 
& cplcChaFecSvL,cplcChaFecSvR,cplcFdFdSvL,cplcFdFdSvR,cplcFdFeSuL,cplcFdFeSuR,           & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSutemp,gTSvtemp,deltaM,         & 
& epsI,check,gChaFdcFdFei)

gChaFdcFdFe(i_run,:,:,:) = gChaFdcFdFei 
gT(i_run) = gT(i_run) + Sum(gChaFdcFdFei) 
...
gChaFecFeFei = 0._dp 
Call ChaToFecFeFe(i_run,MFe,MSv,MCha,cplcChaFecSvL,cplcChaFecSvR,cplcFeFeSvL,         & 
& cplcFeFeSvR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSvtemp,             & 
& deltaM,epsI,check,gChaFecFeFei)

gChaFecFeFe(i_run,:,:,:) = gChaFecFeFei 
gT(i_run) = gT(i_run) + Sum(gChaFecFeFei) 
 
gChaFvcFuFdi = 0._dp 
Call ChaToFvcFuFd(i_run,MFu,MFd,MSe,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,             & 
& cplcChaFvSeL,cplcChaFvSeR,cplcFuFdcSeL,cplcFuFdcSeR,cplFvFdcSdL,cplFvFdcSdR,           & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSetemp,gTSdtemp,deltaM,         & 
& epsI,check,gChaFvcFuFdi)

gChaFvcFuFd(i_run,:,:,:) = gChaFvcFuFdi 
gT(i_run) = gT(i_run) + Sum(gChaFvcFuFdi) 
 
gChaFvFvFei = 0._dp 
Call ChaToFvFvFe(i_run,MFe,MSe,MCha,cplcChaFvSeL,cplcChaFvSeR,cplFvFecSeL,            & 
& cplFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSetemp,             & 
& deltaM,epsI,check,gChaFvFvFei)

gChaFvFvFe(i_run,:,:,:) = gChaFvFvFei 
gT(i_run) = gT(i_run) + Sum(gChaFvFvFei) 
 
gChacFuFuFei = 0._dp 
Call ChaTocFuFuFe(i_run,MFu,MFe,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,cplFeFucSdL,     & 
& cplFeFucSdR,IntegralSs,IntegralSSss,NSs,NSSss,gTSdtemp,deltaM,epsI,check,              & 
& gChacFuFuFei)

gChacFuFuFe(i_run,:,:,:) = gChacFuFuFei 
gT(i_run) = gT(i_run) + Sum(gChacFuFuFei) 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChaFdcFdFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=gt1,3
gPartial(i1,n_length)= gChaFecFeFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChaFvcFuFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=gt1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChaFvFvFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFuFuFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine ChaToChaFvFv(iIN,MCha,MVZ,MSe,cplcChaChaVZL,cplcChaChaVZR,cplcChaFvSeL,    & 
& cplcChaFvSeR,cplFvChacSeL,cplFvChacSeR,cplFvFvVZL,cplFvFvVZR,IntegralSs,               & 
& IntegralSSss,IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
& NSSst,NVs,NVSst,NVVss,gTVZ,gTSe,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MCha(2),MVZ,MSe(6)

Complex(dp),Intent(in) :: cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaFvSeL(2,3,6),cplcChaFvSeR(2,3,6),        & 
& cplFvChacSeL(3,2,6),cplFvChacSeR(3,2,6),cplFvFvVZL(3,3),cplFvFvVZR(3,3)
...
Subroutine ChaToChiFvFe(iIN,MChi,MFe,MVWm,MHpm,MSv,MSe,MCha,cplcChaChiHpmL,           & 
& cplcChaChiHpmR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,              & 
& cplcChaFvSeL,cplcChaFvSeR,cplChiFecSeL,cplChiFecSeR,cplChiFvSvL,cplChiFvSvR,           & 
& cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,cplFvFecVWmR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,              & 
...
Complex(dp),Intent(in) :: cplcChaChiHpmL(2,4,2),cplcChaChiHpmR(2,4,2),cplcChaChiVWmL(2,4),cplcChaChiVWmR(2,4),  & 
...
& cplFvFecHpmL(3,3,2),cplFvFecHpmR(3,3,2),cplFvFecVWmL(3,3),cplFvFecVWmR(3,3)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Chi Fv Fe Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Chi Fv Fe Propagator: VWm,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Chi Fv Fe Propagator: Hpm,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Chi Fv Fe Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Chi Fv Fe Propagator: conj[Sv],Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChaToFdcFdFe(iIN,MFd,MFe,MSu,MSv,MCha,cplcChaFdcSuL,cplcChaFdcSuR,         & 
& cplcChaFecSvL,cplcChaFecSvR,cplcFdFdSvL,cplcFdFdSvR,cplcFdFeSuL,cplcFdFeSuR,           & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSu,gTSv,deltaM,epsI,            & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFe(3),MSu(6),MSv(3),MCha(2)

Complex(dp),Intent(in) :: cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),  & 
& cplcFdFdSvL(3,3,3),cplcFdFdSvR(3,3,3),cplcFdFeSuL(3,3,6),cplcFdFeSuR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSu(6),gTSv(3)
...
If(Abs(MCha(iIN)).gt.(Abs(MFe(gt3))+Abs(MFd(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Su] 
!-------------- 
Do i1=1,6
...
coup(4) = Conjg(cplcFdFeSuL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFdFeSuR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd cFd Fe Propagator: conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd cFd Fe Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(5) = cplcFdFeSuL(gt2,gt3,i1) 
coup2(6) = cplcFdFeSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFdFeSuL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFdFeSuR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd cFd Fe Propagator: conj[Su],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd cFd Fe Propagator: conj[Su],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Su],conj[Sv]'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd cFd Fe Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChaToFecFeFe(iIN,MFe,MSv,MCha,cplcChaFecSvL,cplcChaFecSvR,cplcFeFeSvL,     & 
& cplcFeFeSvR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSv,deltaM,          & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MSv(3),MCha(2)
...
If(Abs(MCha(iIN)).gt.(Abs(MFe(gt3))+Abs(MFe(gt2))+Abs(MFe(gt1)))) Then 
!-------------- 
!  conj[Sv] 
!-------------- 
Do i1=1,3
...
coup(2) = Conjg(cplcChaFecSvL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChaFecSvR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFeFeSvL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFeFeSvR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt3) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcChaFecSvL(iIN,gt3,i1) 
coup2(2) = cplcChaFecSvR(iIN,gt3,i1) 
coup2(3) = Conjg(cplcChaFecSvL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChaFecSvR(iIN,gt1,i1))  
coup2(5) = cplcFeFeSvL(gt2,gt1,i1) 
coup2(6) = cplcFeFeSvR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFeFeSvL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplcFeFeSvR(gt2,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fe cFe Fe Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcChaFecSvL(iIN,gt1,i1) 
coup2(2) = cplcChaFecSvR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcChaFecSvL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChaFecSvR(iIN,gt1,i2))  
coup2(5) = cplcFeFeSvL(gt2,gt3,i1) 
coup2(6) = cplcFeFeSvR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFeFeSvL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFeFeSvR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fe cFe Fe Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaToFecFeFe 
 
 
Subroutine ChaToFvcFuFd(iIN,MFu,MFd,MSe,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,         & 
& cplcChaFvSeL,cplcChaFvSeR,cplcFuFdcSeL,cplcFuFdcSeR,cplFvFdcSdL,cplFvFdcSdR,           & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSe,gTSd,deltaM,epsI,            & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MSe(6),MSd(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaFvSeL(2,3,6),cplcChaFvSeR(2,3,6),    & 
& cplcFuFdcSeL(3,3,6),cplcFuFdcSeR(3,3,6),cplFvFdcSdL(3,3,6),cplFvFdcSdR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSe(6),gTSd(6)
...
If(Abs(MCha(iIN)).gt.(Abs(MFd(gt3))+Abs(MFu(gt2))+Abs(0.))) Then 
!-------------- 
!  Se 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplcChaFvSeL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChaFvSeR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFuFdcSeL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFuFdcSeR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv cFu Fd Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcChacFuSdL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChacFuSdR(iIN,gt2,i1)) 
coup(4) = Conjg(cplFvFdcSdL(gt1,gt3,i1)) 
coup(3) = Conjg(cplFvFdcSdR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv cFu Fd Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcChaFvSeL(iIN,gt1,i1) 
coup2(2) = cplcChaFvSeR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcChaFvSeL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChaFvSeR(iIN,gt1,i2))  
coup2(5) = cplcFuFdcSeL(gt2,gt3,i1) 
coup2(6) = cplcFuFdcSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFuFdcSeL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFuFdcSeR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv cFu Fd Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(5) = cplcFuFdcSeL(gt2,gt3,i1) 
coup2(6) = cplcFuFdcSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFvFdcSdL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFvFdcSdR(gt1,gt3,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv cFu Fd Propagator: Se,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Se,Sd'
        End Do 
      End Do 
...
coup2(3) = Conjg(cplcChacFuSdL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplcChacFuSdR(iIN,gt2,i2))  
coup2(5) = cplFvFdcSdL(gt1,gt3,i1) 
coup2(6) = cplFvFdcSdR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFvFdcSdL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFvFdcSdR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv cFu Fd Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaToFvcFuFd 
 
 
Subroutine ChaToFvFvFe(iIN,MFe,MSe,MCha,cplcChaFvSeL,cplcChaFvSeR,cplFvFecSeL,        & 
& cplFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSe,deltaM,          & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChaFvSeL(2,3,6),cplcChaFvSeR(2,3,6),cplFvFecSeL(3,3,6),cplFvFecSeR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSe(6)
...
If(Abs(MCha(iIN)).gt.(Abs(MFe(gt3))+Abs(0.)+Abs(0.))) Then 
!-------------- 
!  Se 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplcChaFvSeL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChaFvSeR(iIN,gt1,i1)) 
coup(4) = Conjg(cplFvFecSeL(gt2,gt3,i1)) 
coup(3) = Conjg(cplFvFecSeR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplcChaFvSeL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChaFvSeR(iIN,gt2,i1)) 
coup(4) = Conjg(cplFvFecSeL(gt1,gt3,i1)) 
coup(3) = Conjg(cplFvFecSeR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcChaFvSeL(iIN,gt2,i1) 
coup2(2) = cplcChaFvSeR(iIN,gt2,i1) 
coup2(3) = Conjg(cplcChaFvSeL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChaFvSeR(iIN,gt1,i1))  
coup2(5) = cplFvFecSeL(gt1,gt3,i1) 
coup2(6) = cplFvFecSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFvFecSeL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplFvFecSeR(gt2,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv Fv Fe Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcChaFvSeL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChaFvSeR(iIN,gt1,i2))  
coup2(5) = cplFvFecSeL(gt2,gt3,i1) 
coup2(6) = cplFvFecSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFvFecSeL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplFvFecSeR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
coup2(5) = cplFvFecSeL(gt1,gt3,i1) 
coup2(6) = cplFvFecSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFvFecSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFvFecSeR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fv Fv Fe Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaToFvFvFe 
 
 
Subroutine ChaTocFuFuFe(iIN,MFu,MFe,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,             & 
& cplFeFucSdL,cplFeFucSdR,IntegralSs,IntegralSSss,NSs,NSSss,gTSd,deltaM,epsI,            & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFe(3),MSd(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplFeFucSdL(3,3,6),cplFeFucSdR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12)

Real(dp),Intent(inout) :: gTSd(6)

Integer, Intent(inout) :: NSs,NSSss
Real(dp),Intent(inout)::g(:,:,:) 
Logical, Intent(in) :: check 
Integer, Intent(in) :: iIN 
Real(dp), Intent(in) :: epsI, deltaM 
...
If(Abs(MCha(iIN)).gt.(Abs(MFe(gt3))+Abs(MFu(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  Sd 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplcChacFuSdL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChacFuSdR(iIN,gt1,i1)) 
coup(4) = Conjg(cplFeFucSdL(gt3,gt2,i1)) 
coup(3) = Conjg(cplFeFucSdR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu Fu Fe Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcChacFuSdL(iIN,gt1,i1) 
coup2(2) = cplcChacFuSdR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcChacFuSdL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChacFuSdR(iIN,gt1,i2))  
coup2(5) = cplFeFucSdL(gt3,gt2,i1) 
coup2(6) = cplFeFucSdR(gt3,gt2,i1) 
coup2(7) = Conjg(cplFeFucSdL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFeFucSdR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu Fu Fe Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaTocFuFuFe 
 
 
End Module Cha3Decays_MSSMTriLnV 
