...
& T2,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,gTAh,gThh,gTHpm,gTSd,           & 
& gTSe,gTSu,gTSv,gTVWm,gTVZ,gChiChicChaCha,gChiChiChiChi,gChiChicFdFd,gChiChicFeFe,      & 
& gChiChicFuFu,gChiChacFdFu,gChiChacFeFv,gChiChiFvFv,gChiFdcFdFv,gChiFdcFdGlu,           & 
& gChiFdcFucFe,gChiFecFeFv,gChiFucFuGlu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& gChiChicFuFu(4,4,3,3),gChiChacFdFu(4,2,3,3),gChiChacFeFv(4,2,3,3),gChiChiFvFv(4,4,3,3),& 
& gChiFdcFdFv(4,3,3,3),gChiFdcFdGlu(4,3,3,1),gChiFdcFucFe(4,3,3,3),gChiFecFeFv(4,3,3,3), & 
& gChiFucFuGlu(4,3,3,1)
...
& gChiChicFuFui(4,3,3),gChiChacFdFui(2,3,3),gChiChacFeFvi(2,3,3),gChiChiFvFvi(4,3,3),    & 
& gChiFdcFdFvi(3,3,3),gChiFdcFdGlui(3,3,1),gChiFdcFucFei(3,3,3),gChiFecFeFvi(3,3,3),     & 
& gChiFucFuGlui(3,3,1)
...
& Yu,Mu,Td,Te,T1,T2,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChaChaAhL,   & 
...
& cplcFdFdhhR,cplcFdFdSvL,cplcFdFdSvR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,              & 
& cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdFvSdL,cplcFdFvSdR,cplcFdGluSdL,           & 
& cplcFdGluSdR,cplcFecFuSdL,cplcFecFuSdR,cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,         & 
...
& cplcFeFvVWmR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcSeL,cplcFuFdcSeR,cplcFuFuAhL,          & 
...
& cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,cplFvChacSeL,           & 
& cplFvChacSeR,cplFvFdcSdL,cplFvFdcSdR,cplFvFecSeL,cplFvFecSeR,cplFvFvVZL,               & 
& cplFvFvVZR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,deltaM)
...
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChiFvcSvL,              & 
& cplChiFvcSvR,cplFvChacSeL,cplFvChacSeR,IntegralSs,IntegralSSss,IntegralSSst,           & 
& IntegralVs,IntegralVSss,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSss,           & 
...
gChiChiFvFvi = 0._dp 
Call ChiToChiFvFv(i_run,MChi,MVZ,MSv,cplChiChiVZL,cplChiChiVZR,cplChiFvcSvL,          & 
& cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,cplFvFvVZL,cplFvFvVZR,IntegralSs,IntegralSSss,    & 
& IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,           & 
& NVVss,gTVZtemp,gTSvtemp,deltaM,epsI,check,gChiChiFvFvi)

gChiChiFvFv(i_run,:,:,:) = gChiChiFvFvi 
gT(i_run) = gT(i_run) + Sum(gChiChiFvFvi) 
 
gChiFdcFdFvi = 0._dp 
Call ChiToFdcFdFv(i_run,MFd,MSd,MSv,MChi,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdcSvL,      & 
& cplcFdFdcSvR,cplcFdFdSvL,cplcFdFdSvR,cplcFdFvSdL,cplcFdFvSdR,cplChiFdcSdL,             & 
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,cplFvFdcSdL,            & 
& cplFvFdcSdR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,             & 
& gTSvtemp,deltaM,epsI,check,gChiFdcFdFvi)

gChiFdcFdFv(i_run,:,:,:) = gChiFdcFdFvi 
gT(i_run) = gT(i_run) + Sum(gChiFdcFdFvi) 
...
gChiFdcFucFei = 0._dp 
Call ChiToFdcFucFe(i_run,MFd,MFu,MFe,MSd,MSe,MSu,MChi,cplcFecFuSdL,cplcFecFuSdR,      & 
& cplcFeChiSeL,cplcFeChiSeR,cplcFeFdcSuL,cplcFeFdcSuR,cplcFuChiSuL,cplcFuChiSuR,         & 
& cplcFuFdcSeL,cplcFuFdcSeR,cplChiFdcSdL,cplChiFdcSdR,IntegralSs,IntegralSSss,           & 
& IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,gTSetemp,gTSutemp,deltaM,epsI,check,             & 
& gChiFdcFucFei)

gChiFdcFucFe(i_run,:,:,:) = gChiFdcFucFei 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFdcFucFei) 
 
gChiFecFeFvi = 0._dp 
Call ChiToFecFeFv(i_run,MFe,MSe,MSv,MChi,cplcFeChiSeL,cplcFeChiSeR,cplcFeFecSvL,      & 
& cplcFeFecSvR,cplcFeFeSvL,cplcFeFeSvR,cplcFeFvSeL,cplcFeFvSeR,cplChiFecSeL,             & 
& cplChiFecSeR,cplChiFvcSvL,cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,cplFvFecSeL,            & 
& cplFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSetemp,             & 
& gTSvtemp,deltaM,epsI,check,gChiFecFeFvi)

gChiFecFeFv(i_run,:,:,:) = gChiFecFeFvi 
gT(i_run) = gT(i_run) + Sum(gChiFecFeFvi) 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChiFdcFdFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gChiFdcFucFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChiFecFeFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
& cplChiFvcSvL,cplChiFvcSvR,cplFvChacSeL,cplFvChacSeR,IntegralSs,IntegralSSss,           & 
...
& cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplFvChacSeL(3,2,6),cplFvChacSeR(3,2,6)
...
Subroutine ChiToChiFvFv(iIN,MChi,MVZ,MSv,cplChiChiVZL,cplChiChiVZR,cplChiFvcSvL,      & 
& cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,cplFvFvVZL,cplFvFvVZR,IntegralSs,IntegralSSss,    & 
& IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,           & 
& NVVss,gTVZ,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(4),MVZ,MSv(3)

Complex(dp),Intent(in) :: cplChiChiVZL(4,4),cplChiChiVZR(4,4),cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),          & 
& cplChiFvSvL(4,3,3),cplChiFvSvR(4,3,3),cplFvFvVZL(3,3),cplFvFvVZR(3,3)
...
coup(2) = Conjg(cplChiFvSvL(iIN,gt2,i1)) 
coup(1) = Conjg(cplChiFvSvR(iIN,gt2,i1)) 
...
coup(2) = Conjg(cplChiFvSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplChiFvcSvL(gt1,gt2,i1)) 
coup(3) = Conjg(cplChiFvcSvR(gt1,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplChiFvSvL(iIN,gt3,i1) 
coup2(2) = cplChiFvSvR(iIN,gt3,i1) 
coup2(3) = Conjg(cplChiFvSvL(iIN,gt2,i1)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt2,i1))  
coup2(5) = cplChiFvcSvL(gt1,gt2,i1) 
coup2(6) = cplChiFvcSvR(gt1,gt2,i1) 
coup2(7) = Conjg(cplChiFvcSvL(gt1,gt3,i1)) 
coup2(8) = Conjg(cplChiFvcSvR(gt1,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFvcSvL(iIN,gt2,i1)) 
coup(1) = Conjg(cplChiFvcSvR(iIN,gt2,i1)) 
coup(4) = Conjg(cplChiFvSvL(gt1,gt3,i1)) 
coup(3) = Conjg(cplChiFvSvR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplChiFvcSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvcSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplChiFvSvL(gt1,gt2,i1)) 
coup(3) = Conjg(cplChiFvSvR(gt1,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt3.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplChiFvcSvL(iIN,gt3,i1) 
coup2(2) = cplChiFvcSvR(iIN,gt3,i1) 
coup2(3) = Conjg(cplChiFvcSvL(iIN,gt2,i1)) 
coup2(4) = Conjg(cplChiFvcSvR(iIN,gt2,i1))  
coup2(5) = cplChiFvSvL(gt1,gt2,i1) 
coup2(6) = cplChiFvSvR(gt1,gt2,i1) 
coup2(7) = Conjg(cplChiFvSvL(gt1,gt3,i1)) 
coup2(8) = Conjg(cplChiFvSvR(gt1,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(3) = Conjg(cplChiFvSvL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt2,i2))  
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(3) = Conjg(cplChiFvSvL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt3,i2))  
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiFvcSvL(gt1,gt2,i2)) 
coup2(8) = Conjg(cplChiFvcSvR(gt1,gt2,i2)) 
coupT = coup2(5) 
coup2(5) = coup2(6) 
coup2(6) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: VZ,Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplChiChiVZL(iIN,gt1) 
coup2(2) = cplChiChiVZR(iIN,gt1) 
coup2(3) = Conjg(cplChiFvcSvL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplChiFvcSvR(iIN,gt2,i2))  
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiFvSvL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplChiFvSvR(gt1,gt3,i2)) 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2*resC 
resC= 1*resC ! color factor 
...
coup2(5) = cplFvFvVZL(gt2,gt3) 
coup2(6) = cplFvFvVZR(gt2,gt3) 
coup2(7) = Conjg(cplChiFvSvL(gt1,gt2,i2)) 
coup2(8) = Conjg(cplChiFvSvR(gt1,gt2,i2)) 
coupT = coup2(5) 
coup2(5) = coup2(6) 
coup2(6) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: VZ,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplChiFvSvL(iIN,gt2,i1) 
coup2(2) = cplChiFvSvR(iIN,gt2,i1) 
coup2(3) = Conjg(cplChiFvSvL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt2,i2))  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: Sv,Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: Sv,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplChiFvcSvL(iIN,gt2,i1) 
coup2(2) = cplChiFvcSvR(iIN,gt2,i1) 
coup2(3) = Conjg(cplChiFvcSvL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplChiFvcSvR(iIN,gt2,i2))  
coup2(5) = cplChiFvSvL(gt1,gt3,i1) 
coup2(6) = cplChiFvSvR(gt1,gt3,i1) 
coup2(7) = Conjg(cplChiFvSvL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplChiFvSvR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Chi Fv Fv Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChiToFdcFdFv(iIN,MFd,MSd,MSv,MChi,cplcFdChiSdL,cplcFdChiSdR,               & 
& cplcFdFdcSvL,cplcFdFdcSvR,cplcFdFdSvL,cplcFdFdSvR,cplcFdFvSdL,cplcFdFvSdR,             & 
& cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,           & 
& cplFvFdcSdL,cplFvFdcSdR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,          & 
& gTSd,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MSd(6),MSv(3),MChi(4)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),cplcFdFdcSvL(3,3,3),cplcFdFdcSvR(3,3,3),      & 
& cplcFdFdSvL(3,3,3),cplcFdFdSvR(3,3,3),cplcFdFvSdL(3,3,6),cplcFdFvSdR(3,3,6),           & 
...
Real(dp),Intent(inout) :: gTSd(6),gTSv(3)
...
If(Abs(MChi(iIN)).gt.(Abs(0.)+Abs(MFd(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Sd] 
!-------------- 
Do i1=1,6
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFvSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFdFdcSvL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFdFdcSvR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFvcSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvcSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFdFdSvL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFdFdSvR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sd],conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(5) = cplcFdFvSdL(gt2,gt3,i1) 
coup2(6) = cplcFdFvSdR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFdFdcSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFdcSvR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sd],Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Sd],Sv'
        End Do 
      End Do 
...
coup2(5) = cplcFdFvSdL(gt2,gt3,i1) 
coup2(6) = cplcFdFvSdR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFdFdSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFdSvR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sd],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Sd],conj[Sv]'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sd],Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(3) = Conjg(cplChiFvSvL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt3,i2))  
coup2(5) = cplcFdFdcSvL(gt2,gt1,i1) 
coup2(6) = cplcFdFdcSvR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFdFdcSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFdcSvR(gt2,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sv,Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sv,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sv,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Sv,Sd'
        End Do 
      End Do 
...
coup2(3) = Conjg(cplChiFvcSvL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplChiFvcSvR(iIN,gt3,i2))  
coup2(5) = cplcFdFdSvL(gt2,gt1,i1) 
coup2(6) = cplcFdFdSvR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFdFdSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFdSvR(gt2,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: conj[Sv],Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Sv],Sd'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFd Fv Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChiToFdcFucFe(iIN,MFd,MFu,MFe,MSd,MSe,MSu,MChi,cplcFecFuSdL,               & 
& cplcFecFuSdR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFdcSuL,cplcFeFdcSuR,cplcFuChiSuL,         & 
& cplcFuChiSuR,cplcFuFdcSeL,cplcFuFdcSeR,cplChiFdcSdL,cplChiFdcSdR,IntegralSs,           & 
& IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSd,gTSe,gTSu,deltaM,epsI,check,            & 
& g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFu(3),MFe(3),MSd(6),MSe(6),MSu(6),MChi(4)

Complex(dp),Intent(in) :: cplcFecFuSdL(3,3,6),cplcFecFuSdR(3,3,6),cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),      & 
& cplcFeFdcSuL(3,3,6),cplcFeFdcSuR(3,3,6),cplcFuChiSuL(3,4,6),cplcFuChiSuR(3,4,6),       & 
& cplcFuFdcSeL(3,3,6),cplcFuFdcSeR(3,3,6),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSd(6),gTSe(6),gTSu(6)
...
If(Abs(MChi(iIN)).gt.(Abs(MFe(gt3))+Abs(MFu(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Sd] 
!-------------- 
Do i1=1,6
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFeChiSeL(gt3,iIN,i1)) 
coup(1) = Conjg(cplcFeChiSeR(gt3,iIN,i1)) 
coup(4) = Conjg(cplcFuFdcSeL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFuFdcSeR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: Su" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: conj[Sd],conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplChiFdcSdL(iIN,gt1,i1) 
coup2(2) = cplChiFdcSdR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcFeChiSeL(gt3,iIN,i2)) 
coup2(4) = Conjg(cplcFeChiSeR(gt3,iIN,i2))  
coup2(5) = cplcFecFuSdL(gt3,gt2,i1) 
coup2(6) = cplcFecFuSdR(gt3,gt2,i1) 
coup2(7) = Conjg(cplcFuFdcSeL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFuFdcSeR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: conj[Sd],Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Sd],Se'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: conj[Sd],Su" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFeChiSeL(gt3,iIN,i1) 
coup2(2) = cplcFeChiSeR(gt3,iIN,i1) 
coup2(3) = Conjg(cplcFeChiSeL(gt3,iIN,i2)) 
coup2(4) = Conjg(cplcFeChiSeR(gt3,iIN,i2))  
coup2(5) = cplcFuFdcSeL(gt2,gt1,i1) 
coup2(6) = cplcFuFdcSeR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFuFdcSeL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFuFdcSeR(gt2,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: Se,Su" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Se,Su'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd cFu cFe Propagator: Su,Su" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MChi(iIN))**3*g
End Subroutine ChiToFdcFucFe 
 
 
Subroutine ChiToFecFeFv(iIN,MFe,MSe,MSv,MChi,cplcFeChiSeL,cplcFeChiSeR,               & 
& cplcFeFecSvL,cplcFeFecSvR,cplcFeFeSvL,cplcFeFeSvR,cplcFeFvSeL,cplcFeFvSeR,             & 
& cplChiFecSeL,cplChiFecSeR,cplChiFvcSvL,cplChiFvcSvR,cplChiFvSvL,cplChiFvSvR,           & 
& cplFvFecSeL,cplFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,          & 
& gTSe,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MSe(6),MSv(3),MChi(4)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),cplcFeFecSvL(3,3,3),cplcFeFecSvR(3,3,3),      & 
& cplcFeFeSvL(3,3,3),cplcFeFeSvR(3,3,3),cplcFeFvSeL(3,3,6),cplcFeFvSeR(3,3,6),           & 
& cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6),cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),       & 
& cplChiFvSvL(4,3,3),cplChiFvSvR(4,3,3),cplFvFecSeL(3,3,6),cplFvFecSeR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSe(6),gTSv(3)
...
If(Abs(MChi(iIN)).gt.(Abs(0.)+Abs(MFe(gt2))+Abs(MFe(gt1)))) Then 
!-------------- 
!  conj[Se] 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplChiFecSeL(iIN,gt1,i1)) 
coup(1) = Conjg(cplChiFecSeR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFeFvSeL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFeFvSeR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Se]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFvSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFeFecSvL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFeFecSvR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFvcSvL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFvcSvR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFeFeSvL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFeFeSvR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFeChiSeL(gt2,iIN,i1)) 
coup(1) = Conjg(cplcFeChiSeR(gt2,iIN,i1)) 
coup(4) = Conjg(cplFvFecSeL(gt3,gt1,i1)) 
coup(3) = Conjg(cplFvFecSeR(gt3,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplChiFecSeL(iIN,gt1,i1) 
coup2(2) = cplChiFecSeR(iIN,gt1,i1) 
coup2(3) = Conjg(cplChiFecSeL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplChiFecSeR(iIN,gt1,i2))  
coup2(5) = cplcFeFvSeL(gt2,gt3,i1) 
coup2(6) = cplcFeFvSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFeFvSeL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFeFvSeR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Se],conj[Se]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(5) = cplcFeFvSeL(gt2,gt3,i1) 
coup2(6) = cplcFeFvSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFeFecSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFeFecSvR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Se],Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Se],Sv'
        End Do 
      End Do 
...
coup2(5) = cplcFeFvSeL(gt2,gt3,i1) 
coup2(6) = cplcFeFvSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFeFeSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFeFeSvR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Se],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Se],conj[Sv]'
        End Do 
      End Do 
...
coup2(5) = cplcFeFvSeL(gt2,gt3,i1) 
coup2(6) = cplcFeFvSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFvFecSeL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvFecSeR(gt3,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Se],Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(3) = Conjg(cplChiFvSvL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplChiFvSvR(iIN,gt3,i2))  
coup2(5) = cplcFeFecSvL(gt2,gt1,i1) 
coup2(6) = cplcFeFecSvR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFeFecSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFeFecSvR(gt2,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Sv,Sv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Sv,conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Sv,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Sv,Se'
        End Do 
      End Do 
...
coup2(3) = Conjg(cplChiFvcSvL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplChiFvcSvR(iIN,gt3,i2))  
coup2(5) = cplcFeFeSvL(gt2,gt1,i1) 
coup2(6) = cplcFeFeSvR(gt2,gt1,i1) 
coup2(7) = Conjg(cplcFeFeSvL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFeFeSvR(gt2,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Sv],conj[Sv]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: conj[Sv],Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(3) = Conjg(cplcFeChiSeL(gt2,iIN,i2)) 
coup2(4) = Conjg(cplcFeChiSeR(gt2,iIN,i2))  
coup2(5) = cplFvFecSeL(gt3,gt1,i1) 
coup2(6) = cplFvFecSeR(gt3,gt1,i1) 
coup2(7) = Conjg(cplFvFecSeL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplFvFecSeR(gt3,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fe cFe Fv Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End Module Chi3Decays_MSSMTriLnV 
