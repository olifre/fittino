...
& cplChiUFvSvR(4,3,3),cplcUChacFuSdL(2,3,6),cplcUChacFuSdR(2,3,6),cplcUChaChaAhL(2,2,2), & 
& cplcUChaChaAhR(2,2,2),cplcUChaChahhL(2,2,2),cplcUChaChahhR(2,2,2),cplcUChaChaVPL(2,2), & 
& cplcUChaChaVPR(2,2),cplcUChaChaVZL(2,2),cplcUChaChaVZR(2,2),cplcUChaChiHpmL(2,4,2),    & 
& cplcUChaChiHpmR(2,4,2),cplcUChaChiVWmL(2,4),cplcUChaChiVWmR(2,4),cplcUChaFdcSuL(2,3,6)

Complex(dp) :: cplcUChaFdcSuR(2,3,6),cplcUChaFecSvL(2,3,3),cplcUChaFecSvR(2,3,3),cplcUChaFvSeL(2,3,6),& 
& cplcUChaFvSeR(2,3,6),cplcUFdChaSuL(3,2,6),cplcUFdChaSuR(3,2,6),cplcUFdChiSdL(3,4,6),   & 
& cplcUFdChiSdR(3,4,6),cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),cplcUFdFdcSvL(3,3,3),     & 
& cplcUFdFdcSvR(3,3,3),cplcUFdFdhhL(3,3,2),cplcUFdFdhhR(3,3,2),cplcUFdFdVGL(3,3),        & 
& cplcUFdFdVGR(3,3),cplcUFdFdVPL(3,3),cplcUFdFdVPR(3,3),cplcUFdFdVZL(3,3),               & 
& cplcUFdFdVZR(3,3),cplcUFdFeSuL(3,3,6),cplcUFdFeSuR(3,3,6),cplcUFdFuHpmL(3,3,2),        & 
& cplcUFdFuHpmR(3,3,2),cplcUFdFuSeL(3,3,6),cplcUFdFuSeR(3,3,6),cplcUFdFuVWmL(3,3),       & 
& cplcUFdFuVWmR(3,3),cplcUFdFvSdL(3,3,6),cplcUFdFvSdR(3,3,6),cplcUFdGluSdL(3,6),         & 
& cplcUFdGluSdR(3,6),cplcUFecFuSdL(3,3,6),cplcUFecFuSdR(3,3,6),cplcUFeChaSvL(3,2,3),     & 
& cplcUFeChaSvR(3,2,3),cplcUFeChiSeL(3,4,6),cplcUFeChiSeR(3,4,6),cplcUFeFdcSuL(3,3,6),   & 
& cplcUFeFdcSuR(3,3,6),cplcUFeFeAhL(3,3,2),cplcUFeFeAhR(3,3,2),cplcUFeFecSvL(3,3,3),     & 
& cplcUFeFecSvR(3,3,3),cplcUFeFehhL(3,3,2),cplcUFeFehhR(3,3,2),cplcUFeFeVPL(3,3),        & 
& cplcUFeFeVPR(3,3),cplcUFeFeVZL(3,3),cplcUFeFeVZR(3,3),cplcUFeFvHpmL(3,3,2),            & 
& cplcUFeFvHpmR(3,3,2),cplcUFeFvSeL(3,3,6),cplcUFeFvSeR(3,3,6),cplcUFeFvVWmL(3,3),       & 
& cplcUFeFvVWmR(3,3),cplcUFuChiSuL(3,4,6),cplcUFuChiSuR(3,4,6),cplcUFuFdcHpmL(3,3,2),    & 
& cplcUFuFdcHpmR(3,3,2),cplcUFuFdcSeL(3,3,6),cplcUFuFdcSeR(3,3,6),cplcUFuFdcVWmL(3,3),   & 
...
& cplcUFuFuVPR(3,3),cplcUFuFuVZL(3,3),cplcUFuFuVZR(3,3),cplcUFuGluSuL(3,6),              & 
& cplcUFuGluSuR(3,6),cplcUHpmVPVWm(2),cplcUHpmVWmVZ(2),cplcVWmcVWmVWmVWm1,               & 
...
& cplFeFucUSdL(3,3,6),cplFeFucUSdR(3,3,6),cplFvChacUSeL(3,2,6),cplFvChacUSeR(3,2,6),     & 
& cplFvFdcUSdL(3,3,6),cplFvFdcUSdR(3,3,6),cplFvFecUHpmL(3,3,2),cplFvFecUHpmR(3,3,2),     & 
& cplFvFecUSeL(3,3,6),cplFvFecUSeR(3,3,6),cplFvFecVWmL(3,3),cplFvFecVWmR(3,3),           & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFdcUSdL(3,6),& 
...
& cplHpmcHpmVPVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),cplHpmcUHpmVP(2,2),          & 
& cplHpmcUHpmVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmSucUSd(2,6,6),cplHpmSvcUSe(2,3,6),& 
& cplHpmUSdcHpmcUSd(2,6,2,6),cplHpmUSecHpmcUSe(2,6,2,6),cplHpmUSucHpmcUSu(2,6,2,6),      & 
& cplHpmUSvcHpmcUSv(2,3,2,3),cplSdcHpmcUSu(6,2,6),cplSdcSdcUSv(6,6,3),cplSdcSdcVWmVWm(6,6),& 
& cplSdcSdVG(6,6),cplSdcSdVGVG(6,6),cplSdcSdVP(6,6),cplSdcSdVPVP(6,6),cplSdcSdVZ(6,6)

Complex(dp) :: cplSdcSdVZVZ(6,6),cplSdcSecUSu(6,6,6),cplSdcSucVWm(6,6),cplSdcUHpmcSu(6,2,6),          & 
...
& cplSecSeVPVP(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecSvcVWm(6,3),cplSecUHpmcSv(6,2,3),& 
& cplSecUSecSv(6,6,3),cplSecUSeVP(6,6),cplSecUSeVZ(6,6),cplSecUSvcVWm(6,3),              & 
& cplSeSucUSd(6,6,6),cplSeUSucSecUSu(6,6,6,6),cplSeUSvcSecUSv(6,3,6,3),cplSucSucVWmVWm(6,6),& 
& cplSucSuVG(6,6),cplSucSuVGVG(6,6),cplSucSuVP(6,6),cplSucSuVPVP(6,6),cplSucSuVZ(6,6),   & 
& cplSucSuVZVZ(6,6),cplSucUSdVWm(6,6),cplSucUSuVG(6,6),cplSucUSuVP(6,6),cplSucUSuVZ(6,6),& 
& cplSuUSvcSucUSv(6,3,6,3),cplSvcSvcVWmVWm(3,3),cplSvcSvVZ(3,3),cplSvcSvVZVZ(3,3),       & 
& cplSvcUSeVWm(3,6),cplSvcUSvVZ(3,3),cplUAhAhhh(2,2,2),cplUAhhhVZ(2,2),cplUAhHpmcHpm(2,2,2),& 
...
& cplUChiFvSvL(4,3,3),cplUChiFvSvR(4,3,3),cplUFvChacSeL(3,2,6),cplUFvChacSeR(3,2,6),     & 
& cplUFvFdcSdL(3,3,6),cplUFvFdcSdR(3,3,6),cplUFvFecHpmL(3,3,2),cplUFvFecHpmR(3,3,2),     & 
& cplUFvFecSeL(3,3,6),cplUFvFecSeR(3,3,6),cplUFvFecVWmL(3,3),cplUFvFecVWmR(3,3),         & 
& cplUFvFvVZL(3,3),cplUFvFvVZR(3,3),cplUhhcVWmVWm(2),cplUhhhhhh(2,2,2),cplUhhHpmcHpm(2,2,2),& 
