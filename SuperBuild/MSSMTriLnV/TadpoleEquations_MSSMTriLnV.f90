...
Subroutine SolveTadpoleEquations(g1,g2,g3,Yd,Ye,L1,L2,Yu,Mu,Td,Te,T1,T2,              & 
...
Subroutine CalculateTadpoles(g1,g2,g3,Yd,Ye,L1,L2,Yu,Mu,Td,Te,T1,T2,Tu,               & 
...
End Module Tadpoles_MSSMTriLnV 
