...
Module FlavorKit_Observables_MSSMTriLnV 
Use Control 
Use Settings 
...
& OddllVRRSM,OddllVLLSM,OddllVRLSM,OddllVLRSM,CC7SM,CC7pSM,BrBtoKee,ratioBtoKee,         & 
& BrBtoKmumu,ratioBtoKmumu)
...
Real(dp), Intent(out) :: BrBtoKee 
Real(dp), Intent(out) :: ratioBtoKee 
...
End Function C1C2 
End Module FlavorKit_Observables_MSSMTriLnV 
