...
Subroutine Gminus2(Ifermion,MAh,MAh2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,              & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,cplcFeFeAhL,     & 
& cplcFeFeAhR,cplcFeChaSvL,cplcFeChaSvR,cplcChaChaVPL,cplcChaChaVPR,cplChiFecSeL,        & 
& cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFdcSuL,           & 
...
& cplcFeFecSvR,cplcFuFuVPL,cplcFuFuVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvSeL,            & 
& cplcFeFvSeR,cplHpmcHpmVP,cplSdcSdVP,cplcFecFuSdL,cplcFecFuSdR,cplSecSeVP,              & 
& cplSucSuVP,a_mu)
...
& MSe2(6),MSu(6),MSu2(6),MSv(3),MSv2(3)
...
& cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),             & 
...
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),             & 
& cplcFeFvSeL(3,3,6),cplcFeFvSeR(3,3,6),cplHpmcHpmVP(2,2),cplSdcSdVP(6,6),               & 
& cplcFecFuSdL(3,3,6),cplcFecFuSdR(3,3,6),cplSecSeVP(6,6),cplSucSuVP(6,6)
...
ratio = MSe2(i2)/MChi2(i1)
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MChi(i1)& 
...
coup1L = cplcFeFdcSuL(gt1,i1,i2)
coup1R = cplcFeFdcSuR(gt1,i1,i2)
coup2L = cplcFdFeSuL(i1,gt2,i3)
coup2R = cplcFdFeSuR(i1,gt2,i3)
ratio = MSu2(i2)/MFd2(i1)
 chargefactor = chargefactor*(0.666667_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MFd(i1)& 
      & +2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MFd2(i1)) 
End if 
...
Do i1= 1,3
  Do i2= 1,6
   i3 = i2
  If ((0._dp.gt.mz2).Or.(MSe2(i2).gt.mz2).Or.(MSe2(i3).gt.mz2)) Then
coup1L = cplcFeFvSeL(gt1,i1,i2)
coup1R = cplcFeFvSeR(gt1,i1,i2)
...
coup1L = cplcFecFuSdL(gt1,i2,i1)
coup1R = cplcFecFuSdR(gt1,i2,i1)
coup2L = cplFeFucSdL(gt2,i3,i1)
coup2R = cplFeFucSdR(gt2,i3,i1)
ratio = MSd2(i1)/MFu2(i2)
 chargefactor = chargefactor*(0.666667_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFu(i2)& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFu2(i2)) 
End if 
...
ratio = MSv2(i1)/MCha2(i2)
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MCha(i2)& 
...
Do i1= 1,3
  Do i2= 1,3
   i3 = i2
  If ((MSv2(i1).gt.mz2).Or.(MFe2(i2).gt.mz2).Or.(MFe2(i3).gt.mz2)) Then
coup1L = cplcFeFeSvL(gt1,i2,i1)
coup1R = cplcFeFeSvR(gt1,i2,i1)
coup2L = cplcFeFecSvL(i3,gt2,i1)
coup2R = cplcFeFecSvR(i3,gt2,i1)
ratio = MSv2(i1)/MFe2(i2)
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFe(i2)& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFe2(i2)) 
...
coup1L = cplcFecFuSdL(gt1,i1,i2)
coup1R = cplcFecFuSdR(gt1,i1,i2)
coup2L = cplFeFucSdL(gt2,i1,i3)
coup2R = cplFeFucSdR(gt2,i1,i3)
ratio = MSd2(i2)/MFu2(i1)
 chargefactor = chargefactor*(0.333333_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MFu(i1)& 
      & +2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MFu2(i1)) 
End if 
...
coup1L = cplcFeFdcSuL(gt1,i2,i1)
coup1R = cplcFeFdcSuR(gt1,i2,i1)
coup2L = cplcFdFeSuL(i3,gt2,i1)
coup2R = cplcFdFeSuR(i3,gt2,i1)
ratio = MSu2(i1)/MFd2(i2)
 chargefactor = chargefactor*(0.333333_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFd(i2)& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFd2(i2)) 
End if 
...
Do i1= 1,3
  Do i2= 1,3
   i3 = i2
  If ((MSv2(i1).gt.mz2).Or.(MFe2(i2).gt.mz2).Or.(MFe2(i3).gt.mz2)) Then
coup1L = cplcFeFecSvL(gt1,i2,i1)
coup1R = cplcFeFecSvR(gt1,i2,i1)
...
Subroutine LeptonEDM(Ifermion,MAh,MAh2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,            & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,            & 
& MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeChaSvL,cplcFeChaSvR,cplcChaChaVPL,        & 
& cplcChaChaVPR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,cplcFdFdVPL,         & 
& cplcFdFdVPR,cplcFeFdcSuL,cplcFeFdcSuR,cplFeFucSdL,cplFeFucSdR,cplFvFecHpmL,            & 
...
& cplcFeFecSvR,cplcFuFuVPL,cplcFuFuVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvSeL,            & 
& cplcFeFvSeR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSdcSdVP,cplcFecFuSdL,            & 
& cplcFecFuSdR,cplSecSeVP,cplSucSuVP,cplcVWmVPVWm,EDM)
...
& cplcChaFecSvR(2,3,3),cplcFeFecSvL(3,3,3),cplcFeFecSvR(3,3,3),cplcFuFuVPL(3,3),         & 
& cplcFuFuVPR(3,3),cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvSeL(3,3,6),           & 
& cplcFeFvSeR(3,3,6),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplHpmcHpmVP(2,2),              & 
& cplSdcSdVP(6,6),cplcFecFuSdL(3,3,6),cplcFecFuSdR(3,3,6),cplSecSeVP(6,6),               & 
& cplSucSuVP(6,6),cplcVWmVPVWm
...
!ratio = MChi2(i1)/MSe2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MChi(i1)/MSe2(i2) 
!End if 
 
ratio = MSe2(i2)/MChi2(i1)
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - chargefactor*(Aimag(coup1L*Conjg(coup1R))*F4(ratio)/MChi(i1)) 
End if 
...
!ratio = MFd2(i1)/MSu2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(2._dp/3._dp)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MFd(i1)/MSu2(i2) 
!End if 
 
ratio = MSu2(i2)/MFd2(i1)
 chargefactor = chargefactor*(0.666667_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - chargefactor*(Aimag(coup1L*Conjg(coup1R))*F4(ratio)/MFd(i1)) 
End if 
...
!ratio = 0._dp/MHpm2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*0./MHpm2(i2) 
!End if 
...
!ratio = 0._dp/MSe2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*0./MSe2(i2) 
!End if 
...
!ratio = MFu2(i2)/MSd2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(2._dp/3._dp)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFu(i2)/MSd2(i1) 
!End if 
 
ratio = MSd2(i1)/MFu2(i2)
 chargefactor = chargefactor*(0.666667_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 0.5_dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*F3gamma(ratio)/MFu(i2)) 
End if 
...
!ratio = MCha2(i2)/MSv2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MCha(i2)/MSv2(i1) 
!End if 
 
ratio = MSv2(i1)/MCha2(i2)
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 0.5_dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*F3gamma(ratio)/MCha(i2)) 
End if 
...
coup2L = cplcFeFecSvL(i3,gt2,i1)
coup2R = cplcFeFecSvR(i3,gt2,i1)
!ratio = MFe2(i2)/MSv2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFe(i2)/MSv2(i1) 
!End if 
...
!ratio = MFu2(i1)/MSd2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1._dp/3._dp)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MFu(i1)/MSd2(i2) 
!End if 
 
ratio = MSd2(i2)/MFu2(i1)
 chargefactor = chargefactor*(0.333333_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - chargefactor*(Aimag(coup1L*Conjg(coup1R))*F4(ratio)/MFu(i1)) 
End if 
...
!ratio = MFd2(i2)/MSu2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1._dp/3._dp)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFd(i2)/MSu2(i1) 
!End if 
 
ratio = MSu2(i1)/MFd2(i2)
 chargefactor = chargefactor*(0.333333_dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 0.5_dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*F3gamma(ratio)/MFd(i2)) 
End if 
...
& cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplChiChacVWmL,cplChiChacVWmR,             & 
& cplChiChiVZL,cplChiChiVZR,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,    & 
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecVWmL,cplFvFecVWmR,             & 
& cplFvFvVZL,cplFvFvVZR,cplhhcVWmVWm,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhHpmcVWm,            & 
& cplhhVZVZ,cplHpmcHpmcVWmVWm,cplHpmcHpmVZ,cplHpmcHpmVZVZ,cplHpmcVWmVP,cplHpmcVWmVZ,     & 
& cplSdcSdcVWmVWm,cplSdcSdVZ,cplSdcSdVZVZ,cplSdcSucVWm,cplSecSecVWmVWm,cplSecSeVZ,       & 
& cplSecSeVZVZ,cplSecSvcVWm,cplSucSucVWmVWm,cplSucSuVZ,cplSucSuVZVZ,cplSvcSvcVWmVWm,     & 
& cplSvcSvVZ,cplSvcSvVZVZ,rho)
...
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecVWmL(3,3),cplFvFecVWmR(3,3),   & 
& cplFvFvVZL(3,3),cplFvFvVZR(3,3),cplhhcVWmVWm(2),cplhhhhcVWmVWm(2,2),cplhhhhVZVZ(2,2),  & 
& cplhhHpmcVWm(2,2),cplhhVZVZ(2),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVZ(2,2),               & 
...
& MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,              & 
& MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,cplcChaChaVPL,cplcChaChaVPR,            & 
...
& cplSucSuVP,cplcVWmVPVWm,cplHpmcHpmVPVP,cplSdcSdVPVP,cplSecSeVPVP,cplSucSuVPVP,         & 
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplAhhhVZ,cplcChaChaVZL,               & 
...
& cplSucSuVPVP(6,6),cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplAhhhVZ(2,2),      & 
...
& cplSdcSdVPVZ(6,6),cplSecSeVPVZ(6,6),cplSucSuVPVZ(6,6),cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2, & 
& cplcVWmVPVWmVZ3
...
End Function C1C2 
End Module LowEnergy_MSSMTriLnV 
