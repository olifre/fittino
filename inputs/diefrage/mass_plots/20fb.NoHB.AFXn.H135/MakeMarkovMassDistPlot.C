...
void MakeMarkovMassDistPlot (const char* filename = "/scratch/hh/current/ilc/bechtle/fittino/output/postProcessed/final/fittino.out.markov.obs2011.msugra.20fb.NoHB.AFXn.H135.root",
