...
void MakeMarkovMassDistPlot (const char* filename = "/scratch/hh/current/ilc/bechtle/fittino/output/postProcessed/TighterCutChi2Applied/fittino.out.markov.obs2011.msugra.0.165fb.HB.AFXn.root",
			     ...
			     const string logoPath = "../../logo_fittino.eps",
