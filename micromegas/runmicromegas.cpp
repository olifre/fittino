...
{
  if (argc != 3) {
    std::cerr << "usage: runmicromegas <Les Houches file> <Les Houches output file to append to>" << std::endl;
    return 1;
  }
  ...
  std::cout << "runmicromegas: reading Les Houches file " << slhafilename << std::endl;
