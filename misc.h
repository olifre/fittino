...
enum ObservableType { mass, Pwidth, xsection, br, xsectionbr, Pedge, xsbr, brratio, brsum, LEObs, brprod, tauFromStau1Polarisation, tauFromNeutralino2Polarisation, SMPrecision, other, weighted, LHCRate, FineTuningParameter, HiggsScalarFermionCoupling, HiggsPseudoScalarFermionCoupling, HiggsBosonCoupling, HiggsSignalsPeakObservable };
...
enum FitModel       { MSSM, mSUGRA, GMSB, AMSB, NMSSM, XMSUGRA, NONUNIVSIMPLIFIED, NUHM1, NUHM2, MHMAX };
