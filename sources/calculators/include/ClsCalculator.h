...
#ifndef FITTINO_CLSCALCULATOR_H
#define FITTINO_CLSCALCULATOR_H
...
namespace Fittino {
   ...
   */
  class ClsCalculator : public SLHACalculatorBase{
    ...
    public:
       ...
       */
                          ClsCalculator( const ModelBase* model, const boost::property_tree::ptree& ptree );
      /*!
       *  Standard destructor.
       */
                          ~ClsCalculator();
