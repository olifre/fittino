...
#ifndef FITTINO_NLLFAST2CALCULATOR_H
#define FITTINO_NLLFAST2CALCULATOR_H

#include <vector>
#include "CalculatorBase.h"

namespace Fittino {
  class NLLFast2Calculator : public CalculatorBase {
    
  public:
    
    NLLFast2Calculator( const ModelBase* model, const boost::property_tree::ptree& ptree );
    ~NLLFast2Calculator();
