...
#include "CheckMATE4Calculator.h"
    ...
    Fittino::CheckMATE4Calculator::CheckMATE4Calculator( const ModelBase* model, const boost::property_tree::ptree& ptree )
...
Fittino::CheckMATE4Calculator::~CheckMATE4Calculator() {

} 

void Fittino::CheckMATE4Calculator::ReadResult() {
	...
	int n = 0;
        while(std::getline(infile, line)){
         ...
         if(line.empty())  break ;
            ...
            std::istringstream ss(line);
            ss>>temp1>>temp2>>temp3>>temp4>>dummy>>dummy>>dummy>>dummy>>temp5>>temp6>>temp7>>temp8>>temp11>>temp12>>temp13>>dummy>>dummy>>dummy>>dummy>>dummy>>temp18>>dummy>>temp10>>dummy>>dummy>>dummy>>dummy>>temp9;
            analysis.push_back(temp1);
            sr.push_back(temp2);
...
void Fittino::CheckMATE4Calculator::ReadrResult() {
...
void Fittino::CheckMATE4Calculator::CalculatePredictions() {
