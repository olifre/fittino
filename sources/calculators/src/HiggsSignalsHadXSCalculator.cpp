...
Fittino::HiggsSignalsHadXSCalculator::HiggsSignalsHadXSCalculator( const ModelBase* model, const boost::property_tree::ptree& ptree )
    :CalculatorBase       ( model                                                                         ),
     _normSM_Gamma_hgg    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_g_g"         )->GetValue() ),
     _normSM_Gamma_htautau( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_tau_tau"     )->GetValue() ),
     _normSM_Gamma_hmumu  ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_mu_mu"       )->GetValue() ),
     _normSM_Gamma_hgaga  ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_gamma_gamma" )->GetValue() ),
     _normSM_Gamma_hWW    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_W_W"         )->GetValue() ),
     _normSM_Gamma_hZZ    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_Z_Z"         )->GetValue() ),
     _normSM_Gamma_hZga   ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_Z_ga"        )->GetValue() ),
     _normSM_Gamma_hbb    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_b_b"         )->GetValue() ),
     _normSM_Gamma_hcc    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_c_c"         )->GetValue() ),
     _normSM_Gamma_hss    ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_Gamma_h_s_s"         )->GetValue() ),
     _normSM_xs_ggh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_ggh"              )->GetValue() ),
     _normSM_xs_bbh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_bbh"              )->GetValue() ),
     _normSM_xs_qqh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_qqh_2flavor"      )->GetValue() ),
     _normSM_xs_tth       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_tth"              )->GetValue() ),
     _normSM_xs_Wh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_Wh"               )->GetValue() ),
     _normSM_xs_Zh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_Zh"               )->GetValue() ),
     _normSM_xs_bh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_8TeV_bh"               )->GetValue() ),
     _normSM_xs_lep       ( 1                                                                                  ),
     _normSM_xs_tev       ( 1                                                                                  ),
