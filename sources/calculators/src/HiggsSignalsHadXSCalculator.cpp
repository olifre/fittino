...
Fittino::HiggsSignalsHadXSCalculator::HiggsSignalsHadXSCalculator( const ModelBase* model, const boost::property_tree::ptree& ptree )
    :CalculatorBase       ( model                                                                         ),
     ...
     _normSM_xs_ggh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_ggh"              )->GetValue() ),
     _normSM_xs_bbh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_bbh"              )->GetValue() ),
     _normSM_xs_qqh       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_qqh_2flavor"      )->GetValue() ),
     _normSM_xs_tth       ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_tth"              )->GetValue() ),
     _normSM_xs_Wh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_Wh"               )->GetValue() ),
     _normSM_xs_Zh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_Zh"               )->GetValue() ),
     _normSM_xs_bh        ( _model->GetCollectionOfQuantities().At( "HDim6_NormSM_xs_bh"               )->GetValue() ),
     _normSM_xs_lep       ( 1                                                                                  ),
     _normSM_xs_tev       ( 1                                                                                  ),
