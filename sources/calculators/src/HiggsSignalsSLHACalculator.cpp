...
Fittino::HiggsSignalsSLHACalculator::HiggsSignalsSLHACalculator( const ModelBase* model, const boost::property_tree::ptree& ptree )
...
void Fittino::HiggsSignalsSLHACalculator::CalculatePredictions() {
    ...
    _Mu_hgammgamma_1lep_ATL                   = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "1" , "17", "", "" );
    _Mu_hgammgamma_conv_central_highPTt_ATL   = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "2" , "17", "", "" );
    _Mu_hgammgamma_conv_central_lowPTt_ATL    = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "3" , "17", "", "" );
    _Mu_hgammgamma_conv_rest_highPTt_ATL      = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "4" , "17", "", "" );
    _Mu_hgammgamma_conv_rest_lowPTt_ATL       = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "5" , "17", "", "" );
    _Mu_hgammgamma_conv_trans_ATL             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "6" , "17", "", "" );
    _Mu_hgammgamma_ETmiss_ATL                 = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "7" , "17", "", "" );
    _Mu_hgammgamma_highmass2jetloose_ATL      = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "8" , "17", "", "" );
    _Mu_hgammgamma_highmass2jettight_ATL      = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "9" , "17", "", "" );
    _Mu_hgammgamma_lowmass2jet_ATL            = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "10", "17", "", "" );
    _Mu_hgammgamma_unconv_central_highPTt_ATL = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "11", "17", "", "" );
    _Mu_hgammgamma_unconv_central_lowPTt_ATL  = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "12", "17", "", "" );
    _Mu_hgammgamma_unconv_rest_highPTt_ATL    = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "13", "17", "", "" );
    _Mu_hgammgamma_unconv_rest_lowPTt_ATL     = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "14", "17", "", "" );
    _Mu_htautau_ATL                           = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "15", "17", "", "" );
    _Mu_hWWlnulnu_ATL                         = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "16", "17", "", "" );
    _Mu_VBFWWlnulnu_ATL                       = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "17", "17", "", "" );
    _Mu_hZZ4l_ATL                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "18", "17", "", "" );
    _Mu_VhVbb_ATL                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "19", "17", "", "" );
    _Mu_hgammagamma_CDF                       = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "20", "17", "", "" );
    _Mu_htautau_CDF                           = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "21", "17", "", "" );
    _Mu_hWW_CDF                               = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "22", "17", "", "" );
    _Mu_tthttbb_CDF                           = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "23", "17", "", "" );
    _Mu_VhVbb_CDF                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "24", "17", "", "" );
    _Mu_hgammagamma_2jet_CMS                  = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "25", "17", "", "" );
    _Mu_hgammagamma_2jetloose_CMS             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "26", "17", "", "" );
    _Mu_hgammagamma_2jettight_CMS             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "27", "17", "", "" );
    _Mu_hgammagamma_e_CMS                     = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "28", "17", "", "" );
    _Mu_hgammagamma_inclusive_CMS             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "29", "17", "", "" );
    _Mu_hgammagamma_ETmiss_CMS                = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "30", "17", "", "" );
    _Mu_hgammagamma_mu_CMS                    = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "31", "17", "", "" );
    _Mu_htautau_01jet_CMS                     = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "32", "17", "", "" );
    _Mu_hWW_01jet_CMS                         = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "33", "17", "", "" );
    _Mu_hZZ4l_01jet_CMS                       = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "34", "17", "", "" );
    _Mu_hZZ4l_2jet_CMS                        = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "35", "17", "", "" );
    _Mu_tthttbb_CMS                           = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "36", "17", "", "" );
    _Mu_VBFtautau_CMS                         = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "37", "17", "", "" );
    _Mu_VBFWW_CMS                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "38", "17", "", "" );
    _Mu_VhVbb_CMS                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "39", "17", "", "" );
    _Mu_VhVtautau_CMS                         = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "40", "17", "", "" );
    _Mu_WhWWW_CMS                             = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "41", "17", "", "" );
    _Mu_hbb_D0                                = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "42", "17", "", "" );
    _Mu_hgammagamma_D0                        = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "43", "17", "", "" );
    _Mu_htautau_D0                            = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "44", "17", "", "" );
    _Mu_hWW_D0                                = _slhaOutputDataStorage->GetEntry( "HiggsSignalsPeakObservables", 2, "45", "17", "", "" );
