/* $Id: SLHADataStorageBase.h 851 2011-01-10 18:01:22Z uhlenbrock $ */
...
namespace Fittino {
  ...
  class SLHADataStorageBase : public DataStorageBase {
    ...
    public:
       ...
       */
                     ~SLHADataStorageBase();
      virtual double GetEntry( const std::string& blockName, const int firstIndex, const int secondIndex ) = 0;
