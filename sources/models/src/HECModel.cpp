...
Fittino::HECModel::HECModel() {
    ...
    _parameterVector.push_back( new PhysicsParameter( "Massh",             "m_{h}",                126., "GeV", "GeV", 0.02, 124., 128., false ) );
    ...
    //_predictionVector.push_back( new SLHAPrediction( "BR_hZ#gamma",                              "#BR hZ#gamma",                                    "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "16", 1 ) );
    //_predictionVector.push_back( new SLHAPrediction( "BR_h#gamma#gamma",                         "#BR h#gamma#gamma",                               "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "17", 1 ) );
    ...
    //_predictionVector.push_back( new SLHAPrediction( "BR_Total",                                 "#BR Total",                                       "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "20", 1 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Delta_SM_hgammagamma",                     "#Delta_{SM}h#gamma#gamma",                        "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "21", 1 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Delta_Total_hgammagamma",                  "#Delta_{Total}h#gamma#gamma",                     "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "22", 1 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Delta_SM_hgg",                             "#Delta_{SM}hgg",                                  "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "23", 1 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Delta_Total_hgg",                          "#Delta_{Total}h#gg",                              "",    "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "24", 1 ) );
