...
Fittino::HECModel::HECModel() {
    ...
    //_predictionVector.push_back( new SLHAPrediction( "R_H_gammagamma",                           "", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "3", "", 1 ) );
    ...
    //_predictionVector.push_back( new SLHAPrediction( "GammaTotal",                            "GeV", slhaModelCalculator, "HiggsSignalsAdditionalPredictions", "7", "", 1 ) );
