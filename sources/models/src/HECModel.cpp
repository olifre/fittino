...
Fittino::HECModel::HECModel() {
    ...
    //_predictionVector.push_back( new SLHAPrediction( "Mu_htautau_ATL",                           "#mu_{h#tau#tau}ATL",                              "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "2", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hWWlnulnu_ATL",                         "#mu_{hWWlnunu}ATL",                               "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "3", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VBFWWlnulnu_ATL",                       "#mu_{VBFWWlnulnu}ATL",                            "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "4", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hZZ4l_ATL",                             "#mu_{hZZ4l}ATL",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "5", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVbb_ATL",                             "#mu_{VhVbb}ATL",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "6", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hgammagamma_CDF",                       "#mu_{h#gamma#gamma}CDF",                          "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "7", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_htautau_CDF",                           "#mu_{h#tau#tau}CDF",                              "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "8", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hWW_CDF",                               "#mu_{hWW}CDF",                                    "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables",  "9", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_tthttbb_CDF",                           "#mu_{tthttb}CDF",                                 "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "10", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVbb_CDF",                             "#mu_{VhVbb}CDF",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "11", "17", 2 ) );
    ...
    //_predictionVector.push_back( new SLHAPrediction( "Mu_htautau_0_1jet_CMS",                    "#mu_{h#tau#tau}0-1jet-CMS",                       "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "13", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hWW_0_1jet_CMS",                        "#mu_{hWW}0-1jet-CMS",                             "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "14", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hZZ4l_0_1jet_CMS",                      "#mu_{hZZ4l}0-1jet-CMS",                           "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "15", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hZZ4l_2jet_CMS",                        "#mu_{hZZ4l}2jet-CMS",                             "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "16", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_tthttbb_CMS",                           "#mu_{tthttb}CMS",                                 "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "17", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VBFtautau_CMS",                         "#mu_{VBF#tau#tau}CMS",                            "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "18", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VBFWW_CMS",                             "#mu_{VBFWW}CMS",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "19", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVbb_CMS",                             "#mu_{VhVbb}CMS",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "20", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVtautau_CMS",                         "#mu_{VhV#tau#tau}CMS",                            "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "21", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_WhWWW_CMS",                             "#mu_{WhWWW}CMS",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "22", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hbb_D0",                                "#mu_{hbb}DO",                                     "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "23", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hgammagamma_D0",                        "#mu_{h#gamma#gamma}DO",                           "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "24", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_htautau_D0",                            "#mu_{h#tau#tau}DO",                               "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "25", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hWW_D0",                                "#mu_{hWw}DO",                                     "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "26", "17", 2 ) );
    ...
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVbb_CMS",                             "#mu_{VhVbb}CMS",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "38", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_VhVtautau_CMS",                         "#mu_{VhV#tau#tau}CMS",                            "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "39", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_WhWWW_CMS",                             "#mu_{WhWWW}CMS",                                  "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "40", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hbb_D0",                                "#mu_{hbb}DO",                                     "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "41", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hgammagamma_D0",                        "#mu_{h#gamma#gamma}DO",                           "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "42", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_htautau_D0",                            "#mu_{h#tau#tau}DO",                               "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "43", "17", 2 ) );
    //_predictionVector.push_back( new SLHAPrediction( "Mu_hWW_D0",                                "#mu_{hWw}DO",                                     "",    "", slhaModelCalculator, "HiggsSignalsPeakObservables", "44", "17", 2 ) );
