		  ...
		  const char* treename = "tree")
{
	...
	else if (!strcmp(leaf->GetName(), "Mu")) strcpy(xtitle, "#mu");
	else if (!strcmp(leaf->GetName(), "Xtau")) strcpy(xtitle, "X_{#tau}");
	else if (!strcmp(leaf->GetName(), "MSelectronR")) strcpy(xtitle, "M_{#tilde{e}_{R}}");
	else if (!strcmp(leaf->GetName(), "MStauR")) strcpy(xtitle, "M_{#tilde{#tau}_{R}}");
	else if (!strcmp(leaf->GetName(), "MSelectronL")) strcpy(xtitle, "M_{#tilde{e}_{L}}");
	else if (!strcmp(leaf->GetName(), "MStauL")) strcpy(xtitle, "M_{#tilde{#tau}_{L}}");
	else if (!strcmp(leaf->GetName(), "Xtop")) strcpy(xtitle, "X_{t}");
	else if (!strcmp(leaf->GetName(), "Xbottom")) strcpy(xtitle, "X_{b}");
	else if (!strcmp(leaf->GetName(), "MSdownR")) strcpy(xtitle, "M_{#tilde{d}_{R}}");
	else if (!strcmp(leaf->GetName(), "MSbottomR")) strcpy(xtitle, "M_{#tilde{b}_{R}}");
	else if (!strcmp(leaf->GetName(), "MSupR")) strcpy(xtitle, "M_{#tilde{u}_{R}}");
	else if (!strcmp(leaf->GetName(), "MStopR")) strcpy(xtitle, "M_{#tilde{t}_{R}}");
	else if (!strcmp(leaf->GetName(), "MSupL")) strcpy(xtitle, "M_{#tilde{u}_{L}}");
	else if (!strcmp(leaf->GetName(), "MStopL")) strcpy(xtitle, "M_{#tilde{t}_{L}}");
	else if (!strcmp(leaf->GetName(), "M1")) strcpy(xtitle, "M_{1}");
	else if (!strcmp(leaf->GetName(), "M2")) strcpy(xtitle, "M_{2}");
	else if (!strcmp(leaf->GetName(), "M3")) strcpy(xtitle, "M_{3}");
	else if (!strcmp(leaf->GetName(), "massA0")) strcpy(xtitle, "m_{A}");
	else if (!strcmp(leaf->GetName(), "massTop")) strcpy(xtitle, "m_{t}");
