...
int main( int argc, char **argv ) {
	...
	if( argc < 2 ) { 
		cout << "usage: ./runTest <histograms.root> <signalGrids.root> <randomSeed>" << endl;
	}
	...
	// 1st argument: name of the file holding the histograms of the p(t) distributions - get these with CreateTestStatisticsHistogramsForLHCToys
