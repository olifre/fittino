...
// massCharm        = 1.2+-0.11             (0)           at theovalue = 1.2            
  ...
  name.push_back("Bsg_npf       "); meas.push_back("1.117+-0.122         "); fitr.push_back("1.137      ");  pull.push_back(0.168288)  ; //  
  name.push_back("dm_s_npf	"); meas.push_back("1.11+-0.32           "); fitr.push_back("1.02       ");  pull.push_back(0.272438)  ; // -
  name.push_back("Btn_npf 	"); meas.push_back("1.15+-0.4            "); fitr.push_back("0.92       ");  pull.push_back(0.585144)  ; // -
  name.push_back("B_sXsll_npf	"); meas.push_back("0.99+-0.32           "); fitr.push_back("0.99       ");  pull.push_back(0.00957275); //  
  name.push_back("Klnu_npf      "); meas.push_back("1.008+-0.014         "); fitr.push_back("0.999      ");  pull.push_back(0.625804)  ; // -
  name.push_back("gmin2m_npf    "); meas.push_back("3.02e-09+-9.02441e-10"); fitr.push_back("2.99461e-09");  pull.push_back(0.0281382) ; // -
  name.push_back("MassW_npf     "); meas.push_back("80.399+-0.0269258    "); fitr.push_back("80.3774    ");  pull.push_back(0.802427)  ; // -
  name.push_back("sin_th_eff_npf"); meas.push_back("0.2324+-0.0012       "); fitr.push_back("0.231395   ");  pull.push_back(0.837317)  ; // -
  name.push_back("GammaZ_npf    "); meas.push_back("2495.2+-2.50799      "); fitr.push_back("2493.25    ");  pull.push_back(0.779191)  ; //  
  name.push_back("R_l_npf       "); meas.push_back("20.767+-0.025        "); fitr.push_back("20.7868    ");  pull.push_back(0.79184)   ; //  
  name.push_back("R_b_npf       "); meas.push_back("0.21629+-0.00066     "); fitr.push_back("0.21582    ");  pull.push_back(0.712712)  ; // -
  name.push_back("R_c_npf       "); meas.push_back("0.1721+-0.003        "); fitr.push_back("0.172166   ");  pull.push_back(0.02215)   ; // -
  name.push_back("A_fbb_npf     "); meas.push_back("0.0992+-0.0016       "); fitr.push_back("0.103801   ");  pull.push_back(2.87586)   ; //  
  name.push_back("A_fbc_npf     "); meas.push_back("0.0707+-0.0035       "); fitr.push_back("0.0741919  ");  pull.push_back(0.997677)  ; //  
  name.push_back("A_b_npf       "); meas.push_back("0.923+-0.02          "); fitr.push_back("0.935031   ");  pull.push_back(0.601536)  ; //  
  name.push_back("A_c_npf       "); meas.push_back("0.67+-0.027          "); fitr.push_back("0.668312   ");  pull.push_back(0.0625263) ; // -
  name.push_back("A_l_npf       "); meas.push_back("0.1513+-0.0021       "); fitr.push_back("0.148018   ");  pull.push_back(1.56263)   ; // -
  name.push_back("Massh0_npf    "); meas.push_back("< 114.4              "); fitr.push_back("113.256    ");  pull.push_back(0.3813)   ;	 // -
  name.push_back("Omega_npf     "); meas.push_back("0.1099+-0.013507     "); fitr.push_back("0.110231   ");  pull.push_back(0.0244983) ; //  
  name.push_back("A_tau_npf     "); meas.push_back("0.1465+-0.0032       "); fitr.push_back("0.148018   ");  pull.push_back(0.474525)  ; //  
  name.push_back("A_fbl_npf     "); meas.push_back("0.01714+-0.00095     "); fitr.push_back("0.0164321  ");  pull.push_back(0.745156)  ; // -
  name.push_back("sigma_had0_npf"); meas.push_back("41.54+-0.037         "); fitr.push_back("41.4045    ");  pull.push_back(3.66305)   ; // -
  name.push_back("dm_k_npf      "); meas.push_back("0.92+-0.14           "); fitr.push_back("1.02277    ");  pull.push_back(0.734042)  ; //  
  name.push_back("DmsDmd_npf    "); meas.push_back("1.09+-0.160312       "); fitr.push_back("0.999972   ");  pull.push_back(0.561576)  ; // -
  name.push_back("alphaem       "); meas.push_back("127.925+-0.016       "); fitr.push_back("127.924    ");  pull.push_back(0.03125)   ; // -
  name.push_back("G_F           "); meas.push_back("1.16639e-05+-1e-10   "); fitr.push_back("1.16639e-05");  pull.push_back(0)         ; //  
  name.push_back("alphas        "); meas.push_back("0.1176+-0.002        "); fitr.push_back("0.117579   ");  pull.push_back(0.01035)   ; // -
  name.push_back("massZ         "); meas.push_back("91.1875+-0.0021      "); fitr.push_back("91.1872    ");  pull.push_back(0.152381)  ; // -
  name.push_back("massBottom    "); meas.push_back("4.2+-0.17            "); fitr.push_back("4.1977     ");  pull.push_back(0.0135176) ; // -
  name.push_back("massTop       "); meas.push_back("172.4+-1.2           "); fitr.push_back("172.381    ");  pull.push_back(0.0154167) ; // -
  name.push_back("massTau       "); meas.push_back("1.77684+-0.00017     "); fitr.push_back("1.77683    ");  pull.push_back(0.0823529) ; // -
  name.push_back("massCharm     "); meas.push_back("1.2+-0.11            "); fitr.push_back("1.2        ");  pull.push_back(0)         ; //  
