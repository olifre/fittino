			       ...
			       int fixComb = -1 ) 
{
  ...
  //  gStyle->SetPalette(1);
  Int_t colors[21] = {kBlue+1,kBlue+2,kBlue+3,kBlue+4,kRed,kRed+1,kRed+2,
		      kBlue+1,kBlue+2,kBlue+3,kBlue+4,kRed,kRed+1,kRed+2,
		      kBlue+1,kBlue+2,kBlue+3,kBlue+4,kRed,kRed+1,kRed+2};
  // there definitely should be some improvemnt in th colour scheme, but it shouldn't matter here...
  gStyle->SetPalette(21,colors);
  gStyle->SetNumberContours(21);
...
//		}
	  ...
	  maxval = 7.;
	  const int contourLineNo1D1s = 7;
	  const int contourLineNo2D2s = 18;
