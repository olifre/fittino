...
void HistogramSettings()
{
   ...
   histogramSetup[8]->SetNBins        (21);
   histogramSetup[8]->SetLeftLimit    (0.2308);
   histogramSetup[8]->SetRightLimit   (0.23185);
   ...
   histogramSetup[10]->SetNBins        (30);
   histogramSetup[10]->SetLeftLimit    (-8000.);
   histogramSetup[10]->SetRightLimit   (4000.);
   ...
   histogramSetup[11]->SetNBins        (45);
   histogramSetup[11]->SetLeftLimit    (-1500.);
   histogramSetup[11]->SetRightLimit   (3000.);
   ...
   histogramSetup[12]->SetNBins        (30);
   histogramSetup[12]->SetLeftLimit    (-600.);
   histogramSetup[12]->SetRightLimit   (2400.);
   ...
   histogramSetup[13]->SetNBins        (40);
   histogramSetup[13]->SetLeftLimit    (-25.);
   histogramSetup[13]->SetRightLimit   (75.);
   ...
   histogramSetup[14]->SetNBins        (19);
   histogramSetup[14]->SetLeftLimit    (166.);
   histogramSetup[14]->SetRightLimit   (185.);
   ...
   histogramSetup[15]->SetNBins        (22);
   histogramSetup[15]->SetLeftLimit    (-11000000.);
   histogramSetup[15]->SetRightLimit   (11000000.);
   ...
   histogramSetup[16]->SetLeftLimit    (-5000000.);
   histogramSetup[16]->SetRightLimit   (9000000.);
   ...
   histChi22 = new TH1F("Chi22", "Chi22", 400, 0., 100.);

   for (Int_t iHistogram = 0; iHistogram < numberOfHistograms; ++iHistogram)
   {
      histogram[iHistogram] = new TH1F(histogramSetup[iHistogram]->GetName(),
	                               histogramSetup[iHistogram]->GetName(),
	                               histogramSetup[iHistogram]->GetNBins(),
	                               histogramSetup[iHistogram]->GetLeftLimit(),
	                               histogramSetup[iHistogram]->GetRightLimit());

      histogram1s[iHistogram] = new TH1F(histogramSetup[iHistogram]->GetName() + "1s",
	                                 histogramSetup[iHistogram]->GetName() + "1s",
	                                 histogramSetup[iHistogram]->GetNBins() * 10,
	                                 histogramSetup[iHistogram]->GetLeftLimit(),
	                                 histogramSetup[iHistogram]->GetRightLimit());

      histogram2s[iHistogram] = new TH1F(histogramSetup[iHistogram]->GetName() + "2s",
	                                 histogramSetup[iHistogram]->GetName() + "2s",
	                                 histogramSetup[iHistogram]->GetNBins() * 10,
	                                 histogramSetup[iHistogram]->GetLeftLimit(),
	                                 histogramSetup[iHistogram]->GetRightLimit());

      histogram[iHistogram]->GetXaxis()->SetTitle(histogramSetup[iHistogram]->GetAxisLabel());
      histogram[iHistogram]->GetYaxis()->SetTitle("Fractions");

      histogram[iHistogram]->SetFillStyle(0);

      histogram1s[iHistogram]->SetFillColor(kBlue - 6);
      histogram1s[iHistogram]->SetLineColor(kBlue - 6);

      histogram2s[iHistogram]->SetFillColor(kBlue - 9);
      histogram2s[iHistogram]->SetLineColor(kBlue - 9);
